...
tags:
  - cv
  - resume
title: Mohamad Masri - Full Stack Developer
...
## **⚡ Executive Summary**
Senior-level Full Stack Developer with **5+ years of experience** specializing in the **VILT stack** (Vue, Inertia, Laravel, Tailwind). Proven track record in building scalable enterprise solutions, optimizing system performance by **40%**, and bridging the gap between high-fidelity Figma designs and robust backend architectures. Expert in **SaaS development**, **API orchestration**, and **DevOps** for self-hosted Linux environments.
...
> - 🎨 [[Recent Articles|Portfolio & Projects]]
