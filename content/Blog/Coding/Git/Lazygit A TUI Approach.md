...
_(Image source: freeCodeCamp.org article linked below)_
...
- **Staging & Committing:**
  ...
  - `a` (in Files panel): Stage/unstage _all_ changes in the Files panel.
...
- **Merging:**
  ...
  - Select the branch you want to merge _into_ your current branch.
...
- **Practice First:** Create a dummy repository (`git init test-repo && cd test-repo`) and play around with Lazygit _before_ using it on important projects.
