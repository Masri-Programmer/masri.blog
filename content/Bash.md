...
alias forge='rm composer.lock bootstrap/cache/{packages.php,services.php} && composer i && sh scripts/{update-xxx-packages.sh,fix-permissions.sh} && php artisan migrate:fresh --seed && php artisan ziggy:generate && php artisan xxx:lang:js && php artisan route:clear && php artisan config:clear && php artisan view:clear && npm run dev && npm run dev'
